...
for lstm_units in [32, 64, 128]:
    for learning_rate in [0.1, 0.01, 0.001]:
        for num_dimensions in [50, 150, 300]:
            ...
            # iterations = 100000
            iterations = 50000
            # num_dimensions = 50  # Dimensions for each word vector # 300 lui mette 300, ma da dove gli esce fuori??
            ...
            with open("config_accuracy.txt", "a") as myfile:
                new_text = 'lstm_units = ' + str(lstm_units) + '\nlearning_rate = ' + str(learning_rate) + \
                           '\nnum_dimensions = ' + str(num_dimensions) + '\nAccuracy = ' + str(sum(scores) / len(scores)) + '\n'
