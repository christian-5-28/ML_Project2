...
wordVectors = np.load('skipgrams/wordvecs_sg_2.npy')
...
wordsList = np.load('skipgrams/word_list_sg_2.npy')
wordsList = wordsList.tolist()  # Originally loaded as numpy array

# ids = create_ids_matrix(positive_files, negative_files, max_seq_length, wordsList

ids = np.load('skipgrams/ids_sg_2.npy')
print(ids.shape)
...
with open("crnn6_model.json", "w") as json_file:
    json_file.write(model_json)
# serialize weights to HDF5
model.save_weights("crnn6_weights.h5")
